...
const features = [
  {
    ...
    description: "Our AI dynamically reallocates capital across DeFi protocols to maximize returns and minimize risk.",
  },
  {
    icon: Coins,
    label: "Aggregated Liquidity Access",
    description: "Seamlessly connect to top protocols like Aave, Compound, and Curve through one intelligent vault.",
  },
  {
    icon: Zap,
    label: "Predictive Optimization Engine",
    description: "Machine learning models analyze on-chain trends to anticipate yield shifts before they happen.",
  },
  {
    icon: TrendingUp,
    label: "Real-Time Performance Tracking",
    description: "Monitor your portfolio's performance with live analytics and transparent yield attribution.",
  },
  {
    icon: Globe,
    label: "Multi-Chain Support",
    description: "Deploy capital across Ethereum, Arbitrum, and Polygon for diversified yield opportunities.",
  },
  {
    icon: Layers,
    label: "Composable Strategy Layers",
    description: "Stack multiple AI-driven strategies to create custom risk-return profiles tailored to your goals.",
  },
];
...
const steps = [
  {
    icon: Database,
    title: "Deposit Funds",
    description: "Connect your wallet and deposit assets into AI-managed vaults via secure smart contracts.",
  },
  {
    icon: Cpu,
    title: "AI Allocation",
    description: "Advanced algorithms continuously route liquidity across protocols based on real-time yield data and risk metrics.",
  },
  {
    icon: LineChart,
    title: "Earn & Auto-Rebalance",
    description: "Your funds automatically optimize for maximum return with zero manual intervention required.",
  },
];
      ...
      <main>
          ...
          <div className="flex flex-col items-center text-center">
            <h1
              className={`relative font-mono text-4xl font-bold sm:text-5xl md:text-6xl lg:text-7xl max-w-4xl mx-auto leading-tight transition-all duration-700 ${
                heroVisible ? "opacity-100 blur-0 translate-y-0" : "opacity-0 blur-lg translate-y-12"
              }`}
            >
              {titleWords.map((text, index) => (
                <span
                  ...
                  style={{
                    animation: heroVisible ? `fadeInUp 0.6s ease-out ${index * 0.15}s forwards` : "none",
                    opacity: 0,
                  }}
                >
                  {text}
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative bg-background p-6 border border-[#FF6B2C]/20">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span className="text-xs font-mono text-[#FF6B2C]">{item.change}</span>
                        </div>
                        <p className="text-3xl font-bold font-mono text-[#FF6B2C]">{item.value}</p>
                      </div>
                    </div>
                  </AnimatedSection>
                ))}
                  ...
                  <div className="relative bg-background border-2 border-[#FF6B2C]/20 p-8 h-full flex flex-col group-hover:border-[#FF6B2C] transition-all duration-300">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl font-mono font-bold mb-2">{feature.label}</h3>
            ...
            <AnimatedSection>
              <div className="text-center mb-16">
                <div className="inline-block px-6 py-2 bg-[#FF6B2C]/10 border border-[#FF6B2C]/30 mb-4">
                  <span className="text-sm font-mono text-[#FF6B2C]">HOW IT WORKS</span>
                </div>
                <h2 className="text-4xl font-mono font-bold">THREE STEPS TO YIELD</h2>
              </div>
            </AnimatedSection>
            ...
            <div className="relative max-w-5xl mx-auto">
              ...
              {steps.map((step, i) => (
                <AnimatedSection key={step.title} delay={i * 200}>
                  <div className={`relative flex ${i % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} items-center mb-16 last:mb-0`}>
                    <div className="flex-1 md:pr-12">
                      {i % 2 === 0 && (
                        <div className="bg-background border-2 border-[#FF6B2C]/30 p-8">
                          <div className="flex items-center gap-4 mb-4">
                            <span className="text-6xl font-mono font-bold text-[#FF6B2C]/20">0{i + 1}</span>
        ...
        <section className="py-16 border-y-2 border-[#FF6B2C]/20 overflow-hidden bg-background">
          <div className="mb-8 text-center">
            <span className="text-xs font-mono text-[#FF6B2C] tracking-wider">POWERED BY</span>
          </div>
            ...
            {[...integrations, ...integrations].map((name, i) => (
              <div key={i} className="flex-shrink-0 mx-8">
                <div className="px-8 py-4 border-2 border-[#FF6B2C]/30 hover:border-[#FF6B2C] hover:bg-[#FF6B2C]/5 transition-all duration-300">
                  <span className="text-2xl font-mono font-bold text-muted-foreground hover:text-[#FF6B2C]">{name}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="py-24 container mx-auto px-4">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl font-mono font-bold">SECURITY PROTOCOL</h2>
            </div>
          </AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl font-mono font-bold">DEVELOPMENT ROADMAP</h2>
              </div>
            </AnimatedSection>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
                  {roadmap.map((r, i) => (
                    <AnimatedSection key={r.q} delay={i * 150}>
                      <div className={`text-center ${r.status === 'active' ? 'opacity-100' : 'opacity-60'}`}>
                        <div className={`w-16 h-16 mx-auto mb-6 border-4 flex items-center justify-center font-mono font-bold text-lg ${
                          r.status === 'active' 
                        ...
                        <h3 className="text-xl font-bold text-[#FF6B2C] mb-2 font-mono">{r.q}</h3>
                        <p className="text-sm text-muted-foreground">{r.m}</p>
                        {r.status === 'active' && (
                          <div className="mt-3">
                            <span className="text-xs font-mono px-3 py-1 bg-[#FF6B2C] text-background">IN PROGRESS</span>
                          </div>
                        )}
                      </div>
                    </AnimatedSection>
            ...
            <AnimatedSection>
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-muted-foreground mb-12 font-mono max-w-2xl mx-auto">
                  Join 42,000+ users maximizing yields with AI-powered DeFi strategies
                </p>
