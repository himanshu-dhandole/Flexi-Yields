...
//       console.log("Amount in strategy:", amountInStrategy);
//       setAmountInStrategy(formatUnits(amountInStrategy as bigint, 18));
//     } catch (error) {
//       console.error("Failed to fetch amount in strategy:", error);
//     }
//   };
...
//           {/* Header */}
//           <div className="border-b-2 border-[#FF6B2C]/20 pb-6 mb-12">
//             <div className="flex items-center gap-3 mb-3">
//               <Terminal className="h-8 w-8 text-[#FF6B2C]" />
//               <h1 className="text-4xl font-mono font-bold">ADMIN CONSOLE</h1>
//             </div>
...
//             <div className="relative bg-[#FF6B2C]/5 border-l-4 border-[#FF6B2C] p-8">
//               <div className="flex items-center gap-3 mb-6">
//                 <Coins className="h-6 w-6 text-[#FF6B2C]" />
//                 <h2 className="text-2xl font-mono font-bold">AIRDROP USDT</h2>
//               </div>
//               <button
//                 onClick={handleAirdrop}
//                 disabled={!address || loading}
//                 className="px-8 py-4 bg-[#FF6B2C] hover:bg-[#FF6B2C]/90 text-white font-mono font-bold transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
//               >
...
//           {/* Alerts */}
//           {error && (
//             <div className="mb-8 border-l-4 border-red-500 bg-red-500/10 p-6">
//               <div className="flex items-start gap-3">
//                 <AlertCircle className="h-6 w-6 text-red-500 flex-shrink-0 mt-1" />
//                 <div>
//                   <strong className="font-mono text-red-500">ERROR:</strong>
...
//           {isSuccess && hash && (
//             <div className="mb-8 border-l-4 border-green-500 bg-green-500/10 p-6">
//               <div className="flex items-start gap-3">
//                 <CheckCircle2 className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
//                 <div className="flex-1">
//                   <strong className="font-mono text-green-500">SUCCESS!</strong>
//                   <p className="text-xs font-mono text-green-400 mt-2 break-all">
//                     TX HASH: {hash}
//                   </p>
//                 </div>
//               </div>
...
//               <h2 className="text-2xl font-mono font-bold">QUICK ACTIONS</h2>
//             </div>
//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
//               <button
//                 onClick={flexBalanceFunc}
//                 disabled={!address || loading}
//                 className="px-6 py-4 border-2 border-[#FF6B2C]/20 hover:border-[#FF6B2C] hover:bg-[#FF6B2C]/5 font-mono text-sm transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
//               >
//                 FLEX BALANCE
//               </button>
...
//                 <div className="relative border-2 border-[#FF6B2C]/20 p-6">
//                   <div className="flex items-center gap-3 mb-4">
//                     <Wallet className="h-5 w-5 text-[#FF6B2C]" />
//                     <h3 className="font-mono font-bold text-lg">FLEX BALANCE</h3>
//                   </div>
...
//                     <h3 className="font-mono font-bold text-lg">VAULT BALANCE</h3>
//                   </div>
//                   <p className="text-4xl font-mono font-bold text-[#FF6B2C]">
//                     {parseFloat(vusdtBalance).toLocaleString()} vUSDT
//                   </p>
...
//             {(strategyAssets.lending || strategyAssets.staking || strategyAssets.liquidity) && (
//               <div className="relative group">
//                 <div className="absolute -inset-1 bg-[#FF6B2C] opacity-0 group-hover:opacity-10 blur transition duration-300" />
//                 <div className="relative border-2 border-[#FF6B2C]/20 p-6">
//                   <div className="flex items-center gap-3 mb-6">
//                     <TrendingUp className="h-5 w-5 text-[#FF6B2C]" />
//                     <h3 className="font-mono font-bold text-lg">STRATEGY ASSETS</h3>
//                   </div>
//                   <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//                     {strategyAssets.lending && (
//                       <div className="border-l-4 border-[#FF6B2C] pl-4">
//                         <p className="text-xs font-mono text-muted-foreground mb-1">LENDING</p>
//                         <p className="text-2xl font-mono font-bold text-foreground">
//                           {parseFloat(strategyAssets.lending).toLocaleString()}
//                         </p>
//                         <p className="text-xs font-mono text-muted-foreground mt-1">USDT</p>
//                       </div>
//                     )}
//                     {strategyAssets.staking && (
//                       <div className="border-l-4 border-[#FF6B2C]/50 pl-4">
//                         <p className="text-xs font-mono text-muted-foreground mb-1">STAKING</p>
//                         <p className="text-2xl font-mono font-bold text-foreground">
//                           {parseFloat(strategyAssets.staking).toLocaleString()}
//                         </p>
//                         <p className="text-xs font-mono text-muted-foreground mt-1">USDT</p>
//                       </div>
//                     )}
//                     {strategyAssets.liquidity && (
//                       <div className="border-l-4 border-[#FF6B2C]/30 pl-4">
...
//                     <h3 className="font-mono font-bold text-lg">STRATEGY INFO</h3>
//                   </div>
...
//                     <h3 className="font-mono font-bold text-lg">VAULT DETAILS</h3>
//                   </div>
...
//                       <p className="font-bold text-foreground">{vaultDetails.totalAssets} USDT</p>
//                     </div>
//                     <div>
//                       <p className="mb-1">Estimated APY</p>
//                       <p className="font-bold text-foreground">{String(vaultDetails.estimatedAPY || "N/A")}</p>
//                     </div>
//                     <div>
//                       <p className="mb-1">Performance Fee</p>
//                       <p className="font-bold text-foreground">{String(vaultDetails.perfFee || "N/A")}</p>
//                     </div>
//                     <div>
//                       <p className="mb-1">Withdrawal Fee</p>
//                       <p className="font-bold text-foreground">{String(vaultDetails.withdrawFee || "N/A")}</p>
//                     </div>
//                     <div className="col-span-full">
//                       <p className="mb-1">Raw Vault Stats</p>
//                       <pre className="text-xs overflow-auto max-h-40">{JSON.stringify(vaultDetails.vaultStats, null, 2)}</pre>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                     <h3 className="font-mono font-bold text-lg">AMOUNT IN STRATEGY</h3>
//                   </div>
//                   <p className="text-2xl font-mono font-bold text-foreground">
//                     {parseFloat(AmountInStrategy).toLocaleString()} USDT
//                   </p>
//                 </div>
//               </div>
//             )}
